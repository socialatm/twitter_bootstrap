...
echo <<<EOT
	<div class="form-group">
		<label for="language-{$user_guid}" class="col-sm-2 control-label">{$label}</label>
		<div class="col-sm-10">
			<div id="language-{$user_guid}" data-initialize="selectlist"  class="btn-group btn-block selectlist">
